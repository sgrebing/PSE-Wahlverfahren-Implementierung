...
public interface KernelExtra extends StdCallLibrary {
     ...
     */
    public static WinNT.HANDLE CreateToolhelp32Snapshot(WinDef.DWORD dwFlags, WinDef.DWORD th32ProcessID) {
     ...
     */
    public static boolean Process32First(WinNT.HANDLE hSnapshot, KernelExtra.PROCESSENTRY32.ByReference lppe) {
		// TODO Auto-generated method stub
		return false;
	}
